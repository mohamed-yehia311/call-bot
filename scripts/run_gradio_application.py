...
try:
    ...
    print("❌ Notice: The 'inquirer' package is not installed. Please install it using 'pip install inquirer'")
    sys.exit(1)
...
from src.stt.utils import get_stt_model
from src.tts.utils import get_tts_model
